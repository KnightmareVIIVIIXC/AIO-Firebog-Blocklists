...
| 📝 | <em>NOTE</em> |
| :---: | :--- |
| 📕 | A strikethrough source on <a href="https://firebog.net/" title=""><s>The Firebog</s></a> contains many false postives and/or is deprecated |
...
| 📚 | The <a href="https://raw.githubusercontent.com/KnightmareVIIVIIXC/AIO-Firebog-Blocklists/main/aiofirebog.txt" title="">all-in-one list</a> merges the green list with the blue list and includes strikethrough sources that are up to date |
