...
| 📝 | <em>NOTE</em> |
| :---: | :--- |
| 📚 | Sources in the <a href="https://raw.githubusercontent.com/KnightmareVIIVIIXC/AIO-Firebog-Blocklists/main/aiofirebog.txt" title="">all-in-one list</a> add extra tracking rules, and the AIO list combines the green list and the blue list |
