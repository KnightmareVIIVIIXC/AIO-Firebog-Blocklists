...
| List | ⬜ | Description |
|---:|:---:|:---|
|Bog (Cross)| 🟧 |Exclusive to The Bog All-In-One (AIO) list • not recommended for use due to false positives, being deprecated, or being biased|
...
| 🟩 | [Fademind Risky Hosts](https://raw.githubusercontent.com/FadeMind/hosts.extras/master/add.Risk/hosts) |
