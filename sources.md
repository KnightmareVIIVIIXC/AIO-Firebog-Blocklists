...
> [!NOTE]
> Not all sources from [The Firebog](https://v.firebog.net) are used in [the lists](https://github.com/KnightmareVIIVIIXC/AIO-Firebog-Blocklists/blob/main/README.md#-the-lists-)
